...
func sendBirdMessage(client *twilio.RestClient, phoneNumber string, birdName string, birdWord BirdWord) error {
...
func main() {
	...
	for _, phoneNumber := range config.PhoneNumbers {
		...
		if err := sendBirdMessage(client, phoneNumber, birdName, birdWord); err != nil {
